...
cyl = Two_N_parameters_cavity_RTVF(apertureRadius=1., frustaRadii=[1.0000001,1.], frustaDepths=[1.,1.], coneDepth=0., el_FRUs=N.array([1.,1.]), el_CON=1., num_rays=10000., precision=0.0001)
